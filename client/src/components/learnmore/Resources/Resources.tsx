  ...
  <ul className="team">
    ...
    <li className="member co-funder">
      ...
      <div className="description">
        <h3>Alex Vazquez</h3>
        <p>
          Alex is a full stack developer. Alex does JavaScript development for
          CodePen, both front end and back, and just about everything else.
          <br />
    ...
    <li className="member">
      ...
      <div className="description">
        <h3>Marie Mosley</h3>
        <p>
          Marie wears a lot of hats. She is our documentation lead, customer
          support maestra, editor, and community manager.
          <br />
    ...
    <li className="member">
      ...
      <div className="description">
        <h3>Stephen Shaw</h3>
        <p>
          Stephen is a designer/developer residing in Houston. He likes to build
    ...
    <li className="member">
      ...
      <div className="description">
        ...
        <p>
          Robert is a full-stack dev with a penchant for open-source work. He
          dwells in the murky depthsmurky depths of JS.
          <br />
    ...
    <li className="member">
      ...
      <div className="description">
        <h3>Dee Vazquez</h3>
        <p>
          Dee is a full stack developer who started her career in finance. She
          can jump from Rails to React to Go, and also manage our finances.
          <br />
